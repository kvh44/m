...
class MassageUserRepository extends EntityRepository implements UserLoaderInterface {
    ...
    public function searchUserBySql($only_total = false, $offset = 0, $limit = 15, $country_id = null, $location_id = null, $color = null, $lang = null, $is_single = null, $age_period = array(), $em) {
    ...
    public function getUserListBo($only_total = false, $offset = 0, $limit = 25, $country_id = null, $lang = null, $is_single = null, $is_active = null, $word = null) {
        $q = $this->createQueryBuilder('u');
