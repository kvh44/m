...
qq.UploadButton = function(o){
    this._options = {
        ...
        hoverClass: 'btn btn-large', // 'qq-upload-button-hover',
        focusClass: 'btn btn-large', //'qq-upload-button-focus'
    };
...
qq.FineUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        template: '<div class="qq-uploader">' +
            ...
            (!this._options.button ? '<div class="qq-upload-button badge"><div>{uploadButtonText}</div></div>' : '') +
            (!this._options.listElement ? '<ul class="qq-upload-list"></ul>' : '') +
            '</div>',

        // template for one item in file list
        fileTemplate: '<li>' +
            '<div class="qq-progress-bar progress progress-striped active"><div class="bar" style="width: 100%;"></div></div>' +
...
qq.extend(qq.FineUploader.prototype, {
    ...
    _onProgress: function(id, fileName, loaded, total){
        ...
        //$(qq(progressBar)).children(":first").css({width: percent + '%'});
